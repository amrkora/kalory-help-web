...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get faqResetA =>
      'يمكنك مسح جميع بياناتك عن طريق مسح بيانات الموقع في المتصفح لهذا التطبيق، أو عن طريق إلغاء تثبيت التطبيق وإعادة تثبيته.';
  ...
  String get privacyDeletionBody =>
      'يمكنك حذف جميع بياناتك في أي وقت عن طريق إلغاء تثبيت التطبيق أو مسح مساحة تخزين التطبيق في إعدادات جهازك.';
